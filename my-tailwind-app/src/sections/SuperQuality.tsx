...
const SuperQuality= () => {
    return(
      <section id="about-us" className='flex items-center justify-center max-container '>
         <div className="flex max-lg:flex-col max-lg:justify-center justify-between items-center w-[85%]  p-2 ">
               <motion.div 
               initial={{opacity:0 , x : -100}}
               whileInView={{opacity: 1 , x : 0}}
               transition={{duration : 1 , ease : 'easeInOut'}}
               viewport={{once : true , amount : 0.2}}
               className="flex-1 justify-center items-center space-y-8 leading-6">
                  <h1 className=" p-8 shadow-xl rounded-xl capitalize font-montserrat font-semibold text-8xl w-[100%] z-50">We provide you 
                     ...
                     <Button label="More Details" className= "bg-violet-400" iconURL={arrowRight}/>
               </motion.div>
               <motion.div 
               initial={{opacity:0 , x : 100}}
               whileInView={{opacity: 1 , x : 0}}
